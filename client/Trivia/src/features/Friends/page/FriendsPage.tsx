...
import { FriendsLockedCard } from '@/features/Friends/components/FriendsLockedCard';
...
export default function FriendsPage({ user, onRequireAuth, onNavigateHome, onOpenFriend }: FriendsProps) {
  const {
    busy,
    error,
    username,
  ...
  if (!user) {
    return <FriendsLockedCard onRequireAuth={onRequireAuth} onNavigateHome={onNavigateHome} />;
  }
