...
const ClassicStyle: any = {
  ...
  /* LEVELS (per-category, story-like) */
  levelsCard: {
    ...glass,
    marginTop: 18,
    padding: 16,
  ...
  levelsTitleWrap: { display: 'flex', flexDirection: 'column', gap: 4 },
  levelsTitle: { fontSize: 16, fontWeight: 950, letterSpacing: -0.2 },
  levelsSubtitle: {
    fontSize: 12,
    fontWeight: 850,
    color: 'rgba(255,255,255,0.82)',
  },
  levelsActions: { display: 'flex', gap: 10, flexWrap: 'wrap' },
  levelsActionBtn: {
    height: 40,
    padding: '0 14px',
    borderRadius: 999,
  ...
  levelCard: (locked: boolean) => ({
    ...glass,
    padding: 16,
    textAlign: 'left',
    cursor: locked ? 'not-allowed' : 'pointer',
    opacity: locked ? 0.55 : 1,
    border: locked ? '1px solid rgba(255,255,255,0.18)' : glass.border,
    minHeight: 118,
  }),
  levelTopRow: {
    display: 'flex',
  ...
  diffEasy: { background: 'rgba(46, 204, 113, 0.20)' },
  diffMedium: { background: 'rgba(241, 196, 15, 0.20)' },
  diffHard: { background: 'rgba(231, 76, 60, 0.20)' },
  poolCount: {
    fontSize: 12,
    fontWeight: 850,
    color: 'rgba(255,255,255,0.82)',
  ...
  starOn: { color: 'rgba(255, 214, 102, 0.98)' },
  starOff: { color: 'rgba(255,255,255,0.35)' },
  ...
  categoryIconTile: (accent: string) => ({
    width: 56,
    height: 56,
    borderRadius: 18,
    display: 'flex',
