...
// services
const categoryService = new CategoryService(categoryRepository, quizQuestionRepository);
...
const quizBuilderController = new QuizBuilderController(quizBuilderService);
